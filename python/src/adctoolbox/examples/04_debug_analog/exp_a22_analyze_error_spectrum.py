"""Error Spectrum Analysis: Sweep across 15 different ADC non-idealities

This experiment demonstrates error spectrum analysis for various ADC impairments.
Analyzes the spectrum of the error signal directly to reveal frequency components
...
fig.suptitle(f'Error Spectrum Analysis: 15 ADC Non-idealities (Fs={params["Fs"]/1e6:.0f} MHz, Fin={params["Fin"]/1e6:.1f} MHz)',
             fontsize=14, fontweight='bold')
plt.tight_layout()

fig_path = (output_dir / 'exp_a22_analyze_error_spectrum.png').resolve()
